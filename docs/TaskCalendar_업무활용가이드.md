...
* **[신규] 음력 기준 매년 반복 일정 (생일/제사/차례)**:
  - 제사, 부모님 생신 등 음력 기준 일정을 등록하면 매년 정확한 양력 일자에 일정이 자동 표시됩니다.
* **[신규] 다채로운 스티커 & 사용자 PNG 스티커 직접 등록/삭제**:
  - `[스티커...]` 버튼을 누르면 직관적인 비주얼 팝업이 열립니다.
  - **내 스티커 (PNG)**: 사용자가 소장한 투명 PNG 이미지 파일을 직접 등록(`➕ PNG 스티커 등록...`)하여 나만의 맞춤 스티커로 꾸밀 수 있으며, 필요 없는 스티커는 마우스 우클릭으로 간편하게 삭제할 수 있습니다.
  - **기본 스티커 & 카테고리별 이모지**: 내장 스티커와 업무, 기념일, 일상, 강조 등 다양한 아이콘을 탭별로 손쉽게 선택할 수 있습니다.
