# K캘린더 (TaskCalendar) v1.7.0 (2026-09-13)

**K캘린더**는 Windows 데스크톱 환경에서 공무 및 업무 효율을 극대화하는 스마트 개인 일정·메모 관리 솔루션입니다.  
새롭게 추가된 **전용 업무 관리자(Task Manager, 상태별 탭·페이징·인라인 수정)**, **Chrome 확장 프로그램 웹 연동(원클릭 일정/업무/메모 수집)**, **스마트 날짜 계산기(D-Day, 기념일, 법정공휴일 제외 영업일/근무일 산정, 나이/근속기간)**, **음력 및 24절기 자동 표기**, **음력 매년 반복 일정(생일/제사)**, **다채로운 일정 스티커/아이콘**, **우측 기준 스마트 확장 및 화면 밖 넘침 방지**, 스마트 플로팅 메모(바탕화면 자동 복원), 첨부파일(폴더 열기 지원), 사전 알람, 전역 단축키, 무손실 로컬 데이터 암호화 저장을 지원합니다.
...
* 🚀 **[Calendar_v1.7.0_20260913.zip 다운로드 (최신 버전)](https://github.com/wookoon2024/TaskCalendar/raw/main/Calendar_v1.7.0_20260913.zip)**
