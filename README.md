...
* 🚀 **[Calendar_v1.9.0_20260923.zip 다운로드 (최신 버전)](https://github.com/wookoon2024/TaskCalendar/raw/main/Calendar_v1.9.0_20260923.zip)**
...
* **🔤 내장 글꼴(Pretendard) & 글꼴·글자 크기 설정 [v1.9.0 최신]**:
  * **Pretendard 글꼴 내장**: 별도 설치 없이 앱에 번들된 Pretendard 글꼴을 기본 적용(등록/업무 관리창/메모 전반)
  * **글꼴 선택 & 글자 크기 배율**: 환경설정 ➔ 스킨 탭에서 원하는 글꼴 패밀리와 글자 크기(작게/보통/크게/아주 크게)를 선택하고 실시간 미리보기 지원
